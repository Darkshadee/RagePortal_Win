...
((Get-Content -path RageKiosk\RageKiosk\loginInfo\userInformation.ini -Raw) -replace 'username=.*', $name) | Set-Content -Path RageKiosk\RageKiosk\loginInfo\userInformation.ini
